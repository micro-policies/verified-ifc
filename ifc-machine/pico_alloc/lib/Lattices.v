...
(* So far, did not try to reduce the number of assumptions (and derive
 the one that are implied by a core def).  Should do that at some
 point... *)
Class JoinSemiLattice (Lab: Type) :=
{ bot : Lab
; bot_dec: forall l, {l = bot} + {l <> bot}
; join : Lab -> Lab -> Lab
; join_comm: forall l1 l2, join l1 l2 = join l2 l1
; join_assoc: forall l1 l2 l3, join l1 (join l2 l3) = join (join l1 l2) l3
; join_id: forall l, join l l = l
; flows : Lab -> Lab -> bool
; flows_dec : forall l1 l2, {flows l1 l2 = true} + {flows l1 l2 = false}
; flows_join: forall l1 l2, flows l1 l2 = true <-> join l1 l2 = l2
