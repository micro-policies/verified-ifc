...
| rte_step : forall s s' s'',
               priv s = true ->
               cstep SysTable s Silent s' -> (* slippery to put None, but justified *)
               runsToEnd s' s'' ->
               runsToEnd s s''.
